...
{
    private readonly BookController _booksController = new BookController();
    ...
    internal void MainMenu()
    {
        ...
        {  
            ...
            var actionChoice = AnsiConsole.Prompt(new SelectionPrompt<MenuAction>().Title("What do you want to do next?").AddChoices(Enum.GetValues<MenuAction>()));
